          ...
          <div class="col-lg-8">
            <div class="p-5">
              ...
              <table class="table" height="190">
                ...
                <tbody>
                  <?php
                  // Declare count variable to store order number in each product row
                  $count = 0;
                  ?>
                  <?php foreach ($allProducts as $product): ?>
                    <?php
                    // Increase 1 if card table have product
                    $count++;
                    ?>
                    <tr class="mb-4">
                      ...
                      <td>$120</td>
                      <td><button class="btn btn-warning text-white"><i class="fas fa-pen-alt"></i> </button></td>
              ...
              <a href="<?php echo APP_URL; ?>" class="btn btn-success text-white"><i class="fas fa-arrow-left"></i>
                Continue Shopping</a>
            </div>
          </div>
